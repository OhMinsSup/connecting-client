...
class LocalforageStorage {
  ...
  constructor(storageKey?: string) {
    this.id = uniqueId('connecting-storage-')
  ...
  async setItem(key: string, value: Record<string, any> | string | number | boolean) {
...
export const ConnectingStorage = new LocalforageStorage()
